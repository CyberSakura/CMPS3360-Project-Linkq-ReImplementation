...
INITIAL_SYSTEM_MESSAGE = (
    ...
    "Users may also provide clarification feedback using one of these exact phrases at the start of their message:\n"
    "- 'You identified the wrong data.' (they will elaborate after the colon)\n"
    "- 'You misunderstood my question.' (they will elaborate after the colon)\n"
    "- 'I want to ask something different:' (followed by the new question)\n"
    "When you receive such a feedback message, treat it as a refinement of the *previous* conversation context rather than a brand-new standalone request. Respond helpfully by acknowledging the correction and asking any follow-up needed before rebuilding or adjusting the SPARQL query.\n\n"
